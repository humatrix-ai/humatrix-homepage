...
export default function Privacy() {
    return (
        <div class="container content">
            <h2>プライバシーポリシー</h2>
            <p>ヒューマトリックス株式会社（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
            ...
            住所: 東京都文京区本郷６丁目２５番１４号宗文館ビル 3F<br/>
            社名: ヒューマトリックス株式会社<br/>
            代表取締役：本田 健人<br/>
            Eメールアドレス: kentohonda@humatrix.jp<br/>
            </p>
        </div>
    )
}